...
export interface CVData {
	...
	education: { period: string; title: string; institution: string; note?: string }[];
...
export const cvData: CVData = {
	...
	experience: [
		...
		},
		{
			...
			description: 'Led development of medical device certified REST APIs.',
			bullets: [
		...
		},
		{
			...
			description: 'Mentoring young students in programming fundamentals and logic.',
			bullets: []
		}
	],
	education: [
